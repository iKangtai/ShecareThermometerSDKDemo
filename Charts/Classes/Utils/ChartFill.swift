...
open class ChartFill: NSObject
{
    ...
    @objc open class func fillWithColor(_ color: NSUIColor) -> ChartFill
    {
        return ChartFill(nsuiColor: color)
    }
    
    @objc open class func fillWithLinearGradient(_ linearGradient: CGGradient, angle: CGFloat) -> ChartFill
    {
    ...
    @objc open class func fillWithCGLayer(_ layer: CGLayer) -> ChartFill
    {
