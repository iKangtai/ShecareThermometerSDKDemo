...
open class ChartYAxisRendererRadarChart: ChartYAxisRenderer
{
    ...
    open override func renderAxisLabels(context: CGContext)
    {
        ...
        for j in 0 ..< labelCount
        {
            ...
            ChartUtils.drawText(context: context, text: label, point: CGPoint(x: p.x + 10.0, y: p.y - labelLineHeight), align: .left, attributes: [NSAttributedStringKey(rawValue: NSAttributedStringKey.font.rawValue): labelFont, NSAttributedStringKey(rawValue: NSAttributedStringKey.foregroundColor.rawValue): labelTextColor])
        }
    }
