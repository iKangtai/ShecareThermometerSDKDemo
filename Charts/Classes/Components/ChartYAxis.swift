...
open class ChartYAxis: ChartAxisBase
{
    ...
    private var _yAxisValueFormatter: ChartYAxisValueFormatter = ChartDefaultYAxisValueFormatter()
    ...
    @objc open weak var valueFormatter: ChartYAxisValueFormatter?
        {
        get
        {
        ...
        set
        {
            _yAxisValueFormatter = newValue ?? ChartDefaultYAxisValueFormatter()
        }
    }
...
//        _defaultValueFormatter.usesGroupingSeparator = true
    ...
    open func getFormattedLabel(_ index: Int) -> String
    {
        ...
        return (valueFormatter?.stringForYValue(index, original: String(format: "%.1f", entries[index])))!
