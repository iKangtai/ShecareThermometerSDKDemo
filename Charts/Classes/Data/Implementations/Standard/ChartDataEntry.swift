...
open class ChartDataEntry: NSObject
{
    ...
    @objc public init(value: Double, xIndex: Int)
    {
        super.init()
    ...
    @objc public init(value: Double, xIndex: Int, data: Any?)
    {
        super.init()
    ...
    {
        return "ChartDataEntry, xIndex: \(xIndex), value \(value), data \(String(describing: data))"
    }
