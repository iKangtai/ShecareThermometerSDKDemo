...
static const CGFloat MBDefaultProgressLabelFontSize = 14.f;
...
- (void)setupViews {
    ...
    progressLabel.textColor = defaultColor;
    progressLabel.font = [UIFont boldSystemFontOfSize:MBDefaultProgressLabelFontSize];
...
- (void)updateIndicators {
    ...
    progressLabel.adjustsFontSizeToFitWidth = NO;
    progressLabel.textAlignment = NSTextAlignmentCenter;
    progressLabel.textColor = self.contentColor;
    progressLabel.font = [UIFont boldSystemFontOfSize:MBDefaultProgressLabelFontSize];
    progressLabel.opaque = NO;
    progressLabel.backgroundColor = [UIColor clearColor];
    _progressLabel = progressLabel;
    ...
    [progressLabel setContentCompressionResistancePriority:998.f forAxis:UILayoutConstraintAxisHorizontal];
    [progressLabel setContentCompressionResistancePriority:998.f forAxis:UILayoutConstraintAxisVertical];
    [self.indicator addSubview:progressLabel];
...
- (void)updateConstraints {
    ...
    if (!IS_EMPTY_STRING(self.progressLabel.text)) {
        [self.indicator addConstraints:@[[NSLayoutConstraint constraintWithItem:self.progressLabel
